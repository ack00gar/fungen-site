...
export const zh = {
  ...
  pricing: {
    eyebrow: '先试后买',
    title: '免费试用，解锁全部潜能。',
    body: '可免费预览 AI 并驱动您的情趣玩具，适用于个人非商业用途。准备就绪后，无限制、无等待地解锁全质量 Pro AI 模型。仅限个人使用。\n商业用途需单独授权，请发送邮件至 fungen_ai@proton.me。',
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: 'FunGen 是否免费？',
        a: 'FunGen 采用先试后买模式。免费下载版供个人非商业使用，包含完整编辑器、播放器、视频库、批量处理及 Doctor 功能，以及每日数次 AI 生成预览和有限额的设备控制，便于您先行体验 AI 与硬件效果。准备就绪后，通过 PayPal 一次性付款，或订阅 Patreon 上的 FunGen 层级（订阅有效期内持续享有 Pro 权益），即可解锁无限制、无等待的全质量 Pro AI 模型。仅限个人使用。商业用途请发送邮件至 fungen_ai@proton.me 获取专属授权。',
      },
      {
        q: '支持哪些设备？',
      ...
      {
        q: '如何付款和解锁？',
        a: '一次性付费层级（Enthusiast、Pro、Pro Perpetual）均通过 PayPal 付款；付款后，通行证将发送至您的电子邮件，在应用中激活即可使用。您也可以订阅 Patreon 上的 FunGen 层级，在会员有效期内持续享有 FunGen Pro 权益。 也可以用 USDT（TRC-20）付款：见价格区的加密货币选项与图文教程。',
      },
      {
        q: '源代码是否公开？',
        a: '代码目前尚未开源。您可以下载各平台的即开即用构建版本；源代码本身暂不对外发布。如有疑问或商业合作需求，请发送邮件至 fungen_ai@proton.me。',
      },
    ],
  },
  finalCta: {
  ...
  footer: {
    ...
    discord: 'Discord',
    contact: '联系我们',
    fine: '© FunGen · 免费供个人非商业使用 · 问题与商务合作：fungen_ai@proton.me',
  },
} satisfies Strings;
