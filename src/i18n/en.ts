...
export type Strings = {
  ...
  footer: { download: string; patreon: string; discord: string; contact: string; fine: string };
};
...
export const en = {
  ...
  hero: {
    head: 'Turn videos into {funscripts}. Right on your computer.',
    ...
    meta: 'Free download, for personal use',
    osCta: 'Download for {os}',
    osAlso: 'Also for {platforms}',
    trust: ['No account', 'No card', 'Local AI'],
  },
  shot: {
  ...
  pricing: {
    ...
    body: 'Preview the AI and drive your toys for free. When you are ready, unlock the full-quality Pro AI models with no limits and no waits. Funscripts you author or edit are yours to share or sell.\nFor a commercial licence, enquire at fungen_ai@proton.me.',
    note: 'Either way it is a one-time payment, and your pass arrives by email.\nSubscribing to the FunGen tier on Patreon also unlocks Pro for as long as your membership is active.',
    plans: [
      {
        name: 'Free',
      ...
      },
      {
        ...
        perks: [
          'Everything in Free',
          'Full-quality AI generation, 1 year',
          'Every Pro model released that year',
          'After 1 year: free features stay',
        ],
        cta: 'Get Pro',
        badge: 'Most popular',
      },
      {
        ...
        perks: [
          'Everything in Pro',
          'Pro AI generation never expires',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'The one-time tiers (Pro, Pro Perpetual) are PayPal payments; after paying, your pass arrives by email, ready to activate in the app. You can also subscribe at the FunGen tier on Patreon, which gives you FunGen Pro for as long as your membership stays active. You can also pay with USDT (TRC-20) crypto - see the crypto option in the pricing section.',
      },
      {
        q: 'Is the source available?',
        a: 'The code is not open source as of now. You can download ready-to-run builds for every platform; the source itself is not published at this time. For questions, or for a commercial licence, enquire at fungen_ai@proton.me.',
      },
    ],
  },
  finalCta: {
  ...
  footer: {
    ...
    discord: 'Discord',
    contact: 'Contact',
    fine: '© FunGen · Free for personal use · Questions and commercial licences: fungen_ai@proton.me',
  },
} satisfies Strings;
