...
export const de = {
  ...
  pricing: {
    ...
    note: 'So oder so ist es eine Einmalzahlung, und dein Pass kommt per E-Mail.\nDie FunGen-Stufe auf Patreon schaltet Pro ebenfalls frei, solange dein Abo läuft.',
    plans: [
      {
        name: 'Free',
        ...
        perks: [
          ...
          'Ein paar KI-Vorschauen pro Tag',
      ...
      },
      {
        ...
        perks: [
          'Alles aus Free',
          'KI-Generierung in voller Qualität, 1 Jahr',
          'Alle Pro-Modelle dieses Jahres',
          'Nach 1 Jahr: Gratis-Funktionen bleiben',
        ],
        cta: 'Pro holen',
      ...
      },
      {
        ...
        perks: [
          'Alles aus Pro',
          'Pro-KI-Generierung läuft nie ab',
