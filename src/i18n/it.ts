...
export const it = {
  langName: 'Italiano',
  seoTitle: 'FunGen · Generatore di funscript con IA per 2D e VR',
  description:
    'Crea funscripts da video 2D e VR con AI, o modificali a mano su una timeline multi-asse. Riproduce sul tuo dispositivo e funziona offline sulla tua macchina. Download gratuito.',
  keywords: [
    'funscript',
    'funscripts',
  ...
  hero: {
    ...
    meta: 'Download gratuito, per uso personale e non commerciale',
    osCta: 'Scarica per {os}',
    osAlso: 'Disponibile anche per {platforms}',
    trust: ["Nessun account", 'Nessuna carta', 'Funziona offline'],
  },
  shot: {
  ...
  pricing: {
    ...
    body: "Anteprima dell'IA e controllo dei tuoi giocattoli gratuiti, per uso individuale e non commerciale. Quando sei pronto, sblocca i modelli Pro IA a piena qualità, senza limiti e senza attese. Solo uso individuale.\nPer uso commerciale è necessaria una licenza separata: scrivi a fungen_ai@proton.me.",
    ...
    plans: [
      ...
      },
      {
        ...
        blurb: 'Controllo dispositivo e streaming senza limiti, per sempre.',
        perks: [
          'Tutto di Free',
          'Controllo dispositivo senza limite di tempo',
          'Streamer senza conto alla rovescia',
          'Perpetuo, senza scadenza',
        ],
        cta: 'Ottieni Enthusiast',
      },
      {
        name: 'Pro',
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: 'FunGen è gratuito?',
        a: 'FunGen è provalo prima di acquistarlo. Il download gratuito, per uso individuale e non commerciale, ti dà l\'editor completo, il player, la libreria, il batch e il Doctor, più alcune anteprime di generazione IA al giorno e il controllo dispositivo limitato, così puoi testare l\'IA e il tuo hardware prima. Quando sei pronto, un pagamento unico su PayPal, o il piano FunGen su Patreon (Pro per tutto il tempo in cui sei abbonato), sblocca i modelli Pro IA a piena qualità senza limiti e senza attese. Solo uso individuale. Per uso commerciale, contatta fungen_ai@proton.me per una licenza specifica.',
      },
      {
      ...
      },
      {
        ...
        a: "I piani una tantum (Enthusiast, Pro, Pro Perpetual) sono pagamenti su PayPal; dopo aver pagato, il tuo pass arriva via email, pronto per essere attivato nell'app. Puoi anche abbonarti al piano FunGen su Patreon, che ti dà FunGen Pro per tutto il tempo in cui il tuo abbonamento è attivo.",
      },
      {
        q: 'Il codice sorgente è disponibile?',
        a: 'Il codice non è open source al momento. Puoi scaricare versioni già pronte per ogni piattaforma; il codice sorgente non è pubblicato al momento. Per domande o uso commerciale, scrivi a fungen_ai@proton.me.',
      },
    ],
  },
  finalCta: {
  ...
  footer: {
    ...
    discord: 'Discord',
    contact: 'Contatti',
    fine: '© FunGen · Download gratuito, per uso personale e non commerciale · Domande e uso commerciale: fungen_ai@proton.me',
  },
} satisfies Strings;
