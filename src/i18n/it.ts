...
export const it = {
  ...
  pricing: {
    ...
    note: "In entrambi i casi è un pagamento unico e il pass arriva via email.\nAnche il piano FunGen su Patreon sblocca Pro finché l'abbonamento resta attivo.",
    plans: [
      {
        name: 'Free',
        ...
        perks: [
          ...
          'Qualche anteprima IA al giorno',
      ...
      },
      {
        ...
        perks: [
          'Tutto di Free',
          'Generazione IA a piena qualità, 1 anno',
          "Tutti i modelli Pro di quell'anno",
          'Dopo 1 anno: il gratuito resta',
        ],
        cta: 'Ottieni Pro',
        badge: 'Più popolare',
      },
      {
        ...
        perks: [
          'Tutto di Pro',
          'La generazione IA Pro non scade mai',
