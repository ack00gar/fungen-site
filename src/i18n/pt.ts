...
export const pt = {
  langName: 'Português',
  seoTitle: 'FunGen · Gerador de Funscript com IA, 2D e VR, offline',
  description:
    'Gere funscripts a partir de vídeo 2D e VR com IA - tudo na sua própria máquina, sem enviar nada. Editor multi-eixo com precisão de frame incluído. Grátis.',
  keywords: [
    'funscript',
    'funscripts',
  ...
  hero: {
    head: 'Converta vídeos em {funscripts}. Direto no seu computador.',
    ...
    meta: 'Download gratuito, para uso pessoal',
    osCta: 'Download para {os}',
    osAlso: 'Também para {platforms}',
    trust: ['Sem conta', 'Sem cartão', 'IA local'],
  },
  shot: {
  ...
  pricing: {
    ...
    body: 'Experimente a IA e controle os seus brinquedos gratuitamente. Quando estiver pronto, desbloqueie os modelos Pro de IA com qualidade total, sem limites e sem esperas. Os funscripts que você cria ou edita são seus: partilhe-os ou venda-os.\nPara uma licença comercial, escreva para fungen_ai@proton.me.',
    note: 'Em qualquer dos casos é um pagamento único e o passe chega por email.\nSubscrever o nível FunGen no Patreon também desbloqueia o Pro enquanto a subscrição estiver ativa.',
    plans: [
      {
        name: 'Free',
        ...
        perks: [
          ...
          'Algumas pré-visualizações de IA por dia',
      ...
      },
      {
        ...
        perks: [
          'Tudo do Free',
          'Geração IA em qualidade total, 1 ano',
          'Todos os modelos Pro desse ano',
          'Após 1 ano: o gratuito fica',
        ],
        cta: 'Obter Pro',
        badge: 'Mais popular',
      },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Os planos pagos únicos (Pro, Pro Perpetual) são pagamentos no PayPal; após pagar, o seu passe chega por email, pronto a ativar na aplicação. Também pode subscrever o nível FunGen no Patreon, que lhe dá FunGen Pro enquanto a sua subscrição estiver ativa. Você também pode pagar com USDT (TRC-20) - veja a opção cripto na seção de preços.',
      },
      {
        q: 'O código-fonte está disponível?',
        a: 'O código não é open source de momento. Pode descarregar versões prontas a executar para todas as plataformas; o código em si não é publicado neste momento. Para questões, ou para uma licença comercial, escreva para fungen_ai@proton.me.',
      },
    ],
  },
  finalCta: {
  ...
  footer: {
    ...
    discord: 'Discord',
    contact: 'Contacto',
    fine: '© FunGen · Gratuito para uso pessoal · Questões e licenças comerciais: fungen_ai@proton.me',
  },
} satisfies Strings;
